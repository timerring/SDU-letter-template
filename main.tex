% SDUletter_example.tex - an example latex file to illustrate SDUletter.cls
%
...
\documentclass[12pt]{SDUletter}
\usepackage{fontspec} 
\usepackage{tikz} 
\usepackage{xcolor}
	\definecolor{sdured}{RGB}{146,13,20}
\usepackage{lipsum}
\usepackage{fancyhdr}
\usepackage{lastpage}
\usepackage{eso-pic}

% if you don't need the random text, please delete the usage of lipsum package.
\usepackage {lipsum}
%
...
%
%\setmainfont{[./public/fonts/Cambria.ttf]}[BoldFont  = [./public/fonts/CambriaBold.ttf], ItalicFont  = [./public/fonts/CambriaItalic.ttf], BoldItalicFont = [./public/fonts/CambriaBoldItalic.ttf] ]
...
\begin{tikzpicture}
    ...
    {\includegraphics[width=0.55\textwidth]{./public/images/background.pdf}};
    \end{tikzpicture}
\vfill}}}
...
\def\name{Sample Name,\\
Associate Professor,\\
School of Computer Science \& Technology, SDU\\
recommender@sdu.edu.cn
}
%
...
\def\Where{\hspace{-1.2mm}\textbf{\color{sdured}%{sdured}
School of Computer Science \& Technology,\\ Shandong University
}} 
%%%%%%%%%%%%  Additional Contact Information %%%%%%%%%%%
%
% Set your preferred primary contact address here.
\def\Address{No.72, Binhai RD} 
%
\def\CityZip{Qingdao 266237, P.R. China} 
%
% Set your SDU e-mail here
\def\Email{\textbf{\color{sdured}E-mail}: recommender@sdu.edu.cn}
%
% Set your preferred contact number here
\def\TEL{\textbf{\color{sdured}Tel}: +86 18888888888}
%
% Set your department or personal website here
\def\URL{\textbf{\color{sdured}URL}: https://sdu.edu.cn/}
%
%%%%%%%%%%%%%%%%  Footer information  %%%%%%%%%%%%%%%%%%
%
...
\def\school{\small{
  SDU $\cdot$
     ~School of Computer Science \& Technology $\cdot$
     ~No.72, Binhai RD $\cdot$
     ~Qingdao, P.R. China} } 
...
%\date{\vspace{10mm} 1 September 2024}  %[[Alternate]]
%
...
% 	 ~~523003
\begin{letter}{
		The Sample University\\ 
		Sample Road, Sample District\\ 
